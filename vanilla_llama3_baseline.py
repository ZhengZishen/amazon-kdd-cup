...
# from vllm import LLM, VllmConfig

# # 调整交换空间大小
# vllm_config = VllmConfig(
#     model="your-model-name",
#     swap_space=8,  # 将交换空间设置为 8 GiB
#     # 其他配置参数
# )
...
class Llama3_70B_ZeroShotModel(ShopBenchBaseModel):
    """
    ...
    def format_prommpts(self, prompts):
        ...
        """
        system_prompt = "You are a helpful online shopping assistant. Please answer the following question about online shopping and follow the given instructions. If your answer is excellent, you will get tips.\n\n"
        formatted_prompts = []
